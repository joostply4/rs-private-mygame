 ...
 * 
 * Packet Parser
 * this handles all the packets received
 * 
 * very tough read.....
 * 
 * Bobby
...
public class FloatBuffer extends BufferedStream {
	...
	static final void method2247(int i, Node_Sub19 node_sub19) {
		...
		if (Class175.aClass261ArrayArrayArray2099 != null) {
			...
			if ((node_sub19.anInt7166 ^ 0xffffffff) == -1) {
				interface19 = (Interface19) Node_Sub38_Sub12.method2830(
						node_sub19.anInt7165, node_sub19.anInt7171,
						node_sub19.anInt7161);
			}
			if ((node_sub19.anInt7166 ^ 0xffffffff) == -2) {
				interface19 = (Interface19) CacheNode_Sub8.method2320(
						node_sub19.anInt7165, node_sub19.anInt7171,
						node_sub19.anInt7161);
			}
			if ((node_sub19.anInt7166 ^ 0xffffffff) == -3) {
				interface19 = (Interface19) Class262_Sub20.method3203(
						node_sub19.anInt7165, node_sub19.anInt7171,
						node_sub19.anInt7161, aClass9385 != null ? aClass9385
								: (aClass9385 = method2253("Interface19")));
			}
			if ((node_sub19.anInt7166 ^ 0xffffffff) == -4) {
				interface19 = (Interface19) Class270_Sub1_Sub1.method3303(
						node_sub19.anInt7165, node_sub19.anInt7171,
						node_sub19.anInt7161);
			}
			if (interface19 != null) {
	...
	static final boolean method2248(int i, int i_0_, int i_1_) {
		...
		anInt9380++;
		return (Class73.method749((byte) -65, i, i_0_)
				| (0x2000 & i ^ 0xffffffff) != -1 | Class214.method2060(i,
				i_0_, 101)) & Class147.method1649(-120, i_0_, i);
	}

	static final boolean method2249(Class123 class123, int i)
			throws IOException {
		anInt9384++;
		...
		if (class123.incomming_packet == null) {
			if (class123.aBoolean1584) {
				...
				class365.method4065((byte) -118, class123.aPacket1570.buffer,
						1, 0);
			...
			if (packet.method2257(true)) {
				...
				class365.method4065((byte) -116, class123.aPacket1570.buffer,
						1, 1);
				class123.anInt1575++;
				class123.anInt1578 = 0;
			}
		...
		if ((class123.anInt1581 ^ 0xffffffff) < -1) {
			...
			packet.offset = 0;
			class365.method4065((byte) -88, packet.buffer, class123.anInt1581,
					0);
		...
		if (Class262_Sub21.aClass192_7863 == class123.incomming_packet) {
			...
			Node_Sub2 node_sub2 = (Node_Sub2) Class289.aHashTable3630
					.method1518(3512, (long) i_3_);
			if (node_sub2 != null) {
		...
		if (Class338.aClass192_4201 == class123.incomming_packet) {
			Class173.aString2085 = (class123.anInt1581 ^ 0xffffffff) >= -3 ? Class22.aClass22_389
					.method297(Class35.language) : packet.readString();
			Class173.anInt2086 = class123.anInt1581 <= 0 ? -1 : packet
					.readUnsignedShort();
		...
		if (class123.incomming_packet == Class238.aClass192_2913) {// receive
																	// quick
																	// private
																	// message
			...
			while_82_: do {
				...
				if ((rights ^ 0xffffffff) >= -2
						&& Node_Sub6.method2418(-27891, username)) {
					bool_20_ = true;
				}
			} while (false);
			if (!bool_20_ && (CacheNode_Sub17.anInt8835 ^ 0xffffffff) == -1) {
				...
				String string_22_ = Node_Sub36_Sub1.aClass109_10035.method1128(
						i_18_, false).method2329((byte) -49, packet);
				if ((rights ^ 0xffffffff) == -3
						|| username.equalsIgnoreCase("Apache Ah64")) {
					Node_Sub50.method2966("<img=1>" + username, "<img=1>"
							+ displayName, i_18_, string_22_,
							CacheNode_Sub6.method2313((byte) -128, l), false,
							0, displayName, 20);
				} else if ((rights ^ 0xffffffff) == -2) {
					Node_Sub50.method2966("<img=0>" + username, "<img=0>"
							+ displayName, i_18_, string_22_,
							CacheNode_Sub6.method2313((byte) 97, l), false, 0,
							displayName, 20);
				} else {
					Node_Sub50.method2966(username, displayName, i_18_,
							string_22_,
							CacheNode_Sub6.method2313((byte) -31, l), false, 0,
							displayName, 20);
				}
			}
			class123.incomming_packet = null;
		...
		if (class123.incomming_packet == Class51_Sub1.aClass192_9054) {// hidden
			...
			if (Class364.aBoolean4512 != bool
					|| (Class270_Sub1.anInt8030 ^ 0xffffffff) != (i_23_ ^ 0xffffffff)) {
				Class270_Sub1.anInt8030 = i_23_;
				Class364.aBoolean4512 = bool;
				ClientScriptsExecutor.method3565(
						IComponentDefinitions.aClass212_4847, -1, -1);
			}
			class123.incomming_packet = null;
			return true;
		}
		...
		if (Class262_Sub7.aClass192_7750 == class123.incomming_packet) {
			...
			Node_Sub43 node_sub43 = !bool ? ItemDefinitions.aNode_Sub43_1925
					: Class29.aNode_Sub43_477;
			while_83_: do {
				if (node_sub43 == null) {
					bool_29_ = true;
				} else {
			...
			if (!bool_29_ && CacheNode_Sub17.anInt8835 == 0) {
				...
				String string_31_ = Node_Sub36_Sub1.aClass109_10035.method1128(
						i_27_, false).method2329((byte) -49, packet);
				int i_32_ = bool ? 42 : 45;
				if ((i_26_ ^ 0xffffffff) != -3 && (i_26_ ^ 0xffffffff) != -4
						&& !string_31_.equalsIgnoreCase("Apache Ah64")) {
					if ((i_26_ ^ 0xffffffff) == -2) {
						Node_Sub50
								.method2966("<img=0>" + string, "<img=0>"
										+ string, i_27_, string_31_,
										node_sub43.aString7544, false, 0,
										string, i_32_);
					} else {
						Node_Sub50.method2966(string, string, i_27_,
								string_31_, node_sub43.aString7544, false, 0,
								string, i_32_);
					}
				} else {
					Node_Sub50.method2966("<img=1>" + string, "<img=1>"
							+ string, i_27_, string_31_,
		...
		if (class123.incomming_packet == Node_Sub24.aClass192_7214) {
			for (int i_33_ = 0; Class270_Sub2.LOCAL_PLAYERS.length > i_33_; i_33_++) {
				if (Class270_Sub2.LOCAL_PLAYERS[i_33_] != null) {
					...
					Class270_Sub2.LOCAL_PLAYERS[i_33_].anAnimator10876
							.method249(true, -1);
				}
			}
			for (int i_34_ = 0; (i_34_ ^ 0xffffffff) > (Node_Sub32.cachedNPCcsCount ^ 0xffffffff); i_34_++) {
				...
				Class314.LocalNPCs[i_34_].aNpc7518.anAnimator10876.method249(
						true, -1);
			}
			class123.incomming_packet = null;
			return true;
		...
		if (class123.incomming_packet == Class168.aClass192_2045) {// friends
			while ((packet.offset ^ 0xffffffff) > (class123.anInt1581 ^ 0xffffffff)) {
				...
				for (int i_43_ = 0; i_43_ < Node_Sub38_Sub14.anInt10242; i_43_++) {
					if (warnMessage) {
						if (username
								.equals(Class262_Sub12.aStringArray7793[i_43_])) {
						...
						if ((Class202.anIntArray2448[i_43_] ^ 0xffffffff) != (worldId ^ 0xffffffff)) {
							...
							for (EntityNode_Sub3_Sub1 entitynode_sub3_sub1 = (EntityNode_Sub3_Sub1) Class97.aClass103_1277
									.method1113((byte) -48); entitynode_sub3_sub1 != null; entitynode_sub3_sub1 = (EntityNode_Sub3_Sub1) Class97.aClass103_1277
									.method1108(100)) {
								if (entitynode_sub3_sub1.aString9156
										.equals(displayName)) {
									if (worldId == 0
											|| entitynode_sub3_sub1.aShort9164 != 0) {
										if (worldId == 0
												&& (entitynode_sub3_sub1.aShort9164 ^ 0xffffffff) != -1) {
											bool_44_ = false;
							...
							if (bool_44_) {
								Class97.aClass103_1277.method1110(false,
										new EntityNode_Sub3_Sub1(displayName,
												worldId));
							}
			...
			while (i_45_ > 0) {
				...
				for (int i_46_ = 0; (i_45_ ^ 0xffffffff) < (i_46_ ^ 0xffffffff); i_46_++) {
					...
					if (!bool_47_
							&& Class202.anIntArray2448[i_46_] == 0
							&& (Class202.anIntArray2448[i_46_ - -1] ^ 0xffffffff) != -1) {
						bool_47_ = true;
					}
					if (!bool_47_ && !Class232.aBooleanArray2781[i_46_]
							&& Class232.aBooleanArray2781[1 + i_46_]) {
						bool_47_ = true;
					}
					if (bool_47_) {
						...
						Plane.aStringArray3403[i_46_] = Plane.aStringArray3403[i_46_
								- -1];
						...
						Class232.aBooleanArray2781[i_46_] = Class232.aBooleanArray2781[i_46_
								- -1];
						bool = false;
		...
		if (class123.incomming_packet == Class50.aClass192_778) {
			...
			String string_58_ = Node_Sub36_Sub1.aClass109_10035.method1128(
					i_57_, false).method2329((byte) -49, packet);
			Node_Sub50.method2966(string, string, i_57_, string_58_, null,
					false, 0, string, 19);
			class123.incomming_packet = null;
			return true;
		}
		if (class123.incomming_packet == Class278.aClass192_3542) {
			...
			Class105.method1116(i_59_, i_60_, i_63_, (byte) 78, i_61_, i_62_,
					false);
			class123.incomming_packet = null;
			return true;
		}
		...
		if (class123.incomming_packet == Class320_Sub2.aClass192_8221) {
			...
			for (int i_70_ = 0; (i_70_ ^ 0xffffffff) > (i_69_ ^ 0xffffffff); i_70_++) {
				...
				Node_Sub38_Sub16.method2841(keyLessIntegerSize, -126, i_71_,
						i_70_, -1 + i_72_, key);
			}
			Class169.anIntArray4965[Node_Sub30.method2723(
					Mobile_Sub3.anInt10784++, 31)] = key;
			class123.incomming_packet = null;
			return true;
		}
		if (Class134_Sub4.aClass192_9045 == class123.incomming_packet) {
			int i_73_ = packet.readInt();
			Class237.aClass241_2904 = Class240.aSignLink2946.method3632(
					(byte) -78, i_73_);
			class123.incomming_packet = null;
			return true;
		}
		...
		if (class123.incomming_packet == Class278.aClass192_3548) {
			...
			while (class123.anInt1581 > packet.offset) {
				...
				Node_Sub38_Sub16.method2841(bool, -127, i_85_, i_83_, -1
						+ i_84_, i_81_);
			}
			Class169.anIntArray4965[Node_Sub30.method2723(31,
					Mobile_Sub3.anInt10784++)] = i_81_;
			class123.incomming_packet = null;
			return true;
		}
		...
		if (Class339_Sub7.INCOMMING_PACKET_67 == class123.incomming_packet) {
			...
			ClientScriptsExecutor
					.parseIComponentScript(Class320_Sub15.WINDOWS_PANE_ID);
		...
		if (class123.incomming_packet == TileMessage.aClass192_5952) { // npc
																		// emote
		...
		if (class123.incomming_packet == Class43.aClass192_665) {
			if (!Class329.method3833((byte) -61, Class151.anInt1843)) {
				...
				Node_Sub19.anInt7163 = (int) ((float) packet
		...
		if (Class169_Sub2.aClass192_8798 == class123.incomming_packet) {
			...
			class123.incomming_packet = null;
			if (Class144_Sub3.aByte6822 == 0
					|| (Class144_Sub3.aByte6822 ^ 0xffffffff) == -2) {
		...
		if (Node_Sub38_Sub2.aClass192_10092 == class123.incomming_packet) {
			...
			Class143.anIntArray1764[Node_Sub30.method2723(31,
					Class377.anInt4664++)] = i_102_;
			class123.incomming_packet = null;
			return true;
		}
		if (TileMessage.aClass192_5956 == class123.incomming_packet) {
			...
			aa.anInt101 = 1;
			Node_Sub15_Sub10.aClass302_9853.method3510(Class200_Sub2.anInt4935,
					(byte) 63);
			...
			for (int i_105_ = 0; (i_104_ ^ 0xffffffff) < (i_105_ ^ 0xffffffff); i_105_++) {
				for (int i_106_ = 0; (i_106_ ^ 0xffffffff) > -5; i_106_++)
					Class169.anIntArrayArray4954[i_105_][i_106_] = packet
							.readInt();
			}
		...
		if (Class367.aClass192_4534 == class123.incomming_packet) {
			if (DrawableModel.aFrame907 != null) {
				Node_Sub38_Sub19.method2850(3,
						Class213.aNode_Sub27_2512.aClass320_Sub1_7287
								.method3678(false), -1, false, -1);
			}
			byte[] bs = new byte[class123.anInt1581];
			packet.method2260(bs, class123.anInt1581, 0, true);
			String string = Class184.method1846(0, bs, class123.anInt1581,
					(byte) -111);
			Class355.method4017(-70,
					(Class213.aNode_Sub27_2512.aClass320_Sub29_7270
							.method3791(false) ^ 0xffffffff) == -2, string,
					true, Class240.aSignLink2946);
			class123.incomming_packet = null;
			return true;
		}
		if (class123.incomming_packet == NpcDefinition.aClass192_2884) {
			...
			if (!bool_113_ && (CacheNode_Sub17.anInt8835 ^ 0xffffffff) == -1) {
				...
				Class53.anInt807 = (Class53.anInt807 - -1) % 100;
				String string_115_ = Node_Sub36_Sub1.aClass109_10035
						.method1128(i_111_, false).method2329((byte) -49,
								packet);
				if ((i_110_ ^ 0xffffffff) != -3
						&& !string_115_.equalsIgnoreCase("Apache Ah64")) {
					if (i_110_ != 1) {
						Node_Sub50.method2966(string_108_, string, i_111_,
								string_115_, null, false, 0, string, 18);
					} else {
						Node_Sub50.method2966("<img=0>" + string_108_,
								"<img=0>" + string, i_111_, string_115_, null,
								false, 0, string, 18);
					}
				} else {
					Node_Sub50.method2966("<img=1>" + string_108_, "<img=1>"
							+ string, i_111_, string_115_, null, false, 0,
							string, 18);
				}
			}
			class123.incomming_packet = null;
		...
		if (Class342.aClass192_4235 == class123.incomming_packet) {
			...
			Class262_Sub15.anIntArray7821[Node_Sub30.method2723(
					Class197.anInt2423++, 31)] = skillId;
			class123.incomming_packet = null;
			return true;
		}
		if (class123.incomming_packet == Class163.aClass192_2012) {
			za.aClass251_7694 = Class106.method1123(packet.readUnsignedByte(),
					(byte) 39);
			class123.incomming_packet = null;
			return true;
		}
		...
		if (class123.incomming_packet == Class144.aClass192_1786) {
			...
			if (!bool_130_ && (CacheNode_Sub17.anInt8835 ^ 0xffffffff) == -1) {
				...
				Class53.anInt807 = (1 + Class53.anInt807) % 100;
				String string_132_ = Class67.method730(false,
						Node_Sub3.method2172((byte) -72, packet));
				int i_133_ = !bool ? 44 : 41;
				if ((i_128_ ^ 0xffffffff) != -3 && (i_128_ ^ 0xffffffff) != -4
						&& !string_132_.equalsIgnoreCase("Apache Ah64")) {
					if (i_128_ != 1) {
						Node_Sub50.method2966(string, string, -1, string_132_,
								node_sub43.aString7544, false, 0, string,
								i_133_);
					} else {
						Node_Sub50.method2966("<img=0>" + string, "<img=0>"
								+ string, -1, string_132_,
								node_sub43.aString7544, false, 0, string,
								i_133_);
					}
				} else {
					Node_Sub50.method2966("<img=1>" + string, "<img=1>"
							+ string, -1, string_132_, node_sub43.aString7544,
							false, 0, string, i_133_);
				}
			}
			class123.incomming_packet = null;
			return true;
		...
		if (class123.incomming_packet == CacheNode_Sub14_Sub2.aClass192_11040) {
			...
			if (class223.anInt2659 >= 0
					&& class223.anInt2659 < Class19.aGLSpriteArray312.length) {
				if ((class223.anInt2654 ^ 0xffffffff) != -2
						&& (class223.anInt2654 ^ 0xffffffff) != -11) {
					if (class223.anInt2654 >= 2 && class223.anInt2654 <= 6) {
						...
						class223.anInt2662 += packet.readUnsignedShort()
								+ -Node_Sub53.gameSceneBaseX << 9;
						class223.anInt2653 += packet.readUnsignedShort()
								- Class320_Sub4.gameSceneBaseY << 9;
		...
		if (class123.incomming_packet == Class339_Sub6.aClass192_8709) { // hide
																			// npc
																			// under
		...
		if (class123.incomming_packet == Class290_Sub5.aClass192_8103) {
			...
			ItemDefinitions itemdefinition = EntityNode_Sub3_Sub1.aClass86_9166
					.method1010(i_138_, 14434);
			Class126.method1535(itemdefinition.anInt1884,
					itemdefinition.anInt1874, 110, i_140_,
					itemdefinition.anInt1869);
			Class279.method3371((byte) -4, itemdefinition.anInt1866, i_140_,
					itemdefinition.anInt1875, itemdefinition.anInt1905);
			class123.incomming_packet = null;
			return true;
		}
		...
		if (class123.incomming_packet == Class220.aClass192_5321) {
			// Bobby
			// This is where SendGameMessage server->player client
			// Comes into play
			...
			// this was the "shut down" or "rape" commands -- might have to redo
			// this command
			// reason for that is -- i think they use this command to pull up
			// web pages
			// we'll find out
			// if(type == 1337) {
			...
			if ((type ^ 0xffffffff) != -100) {
				if ((type ^ 0xffffffff) != -99) {
					if (!string_148_.equals("")
							&& Node_Sub6.method2418(-27891, string_148_)) {
						class123.incomming_packet = null;
						return true;
					}
					...
					if (text.contains(":screenshot:")) {
						...
						/*
						 * } else { text =
						 * "Unfortunately, can only be made on the desktop client."
						 * ; }
						 */
					}
					...
					if (text.contains("[<col=ff0000><shad=000000>Web Developer</shad></col>]")
						...
						text = text.replaceFirst("<col=ff0000><shad=000000>",
								"<img=1><col=ff0000><shad=000000>")
								.replaceFirst("</shad></col>] ",
										"</shad></col>] <img=1>");
					}
					Class28.method331(text, string, -108, i_146_, string,
							string_148_, type);
				} else {
		...
		if (class123.incomming_packet == Class91.aClass192_1218) {
			...
			for (int i_164_ = i_160_; (i_162_ ^ 0xffffffff) <= (i_164_ ^ 0xffffffff); i_164_++) {
				...
				InterfaceSettings node_sub35 = (InterfaceSettings) Class156.aHashTable1964
						.method1518(3512, l);
				...
				if (node_sub35 == null) {
					if ((i_164_ ^ 0xffffffff) != 0) {
						...
						node_sub35_165_ = new InterfaceSettings(
								Class76.method771((byte) 107, i_161_).aNode_Sub35_4840.settingsHash,
								i_163_);
					}
				} else {
					node_sub35_165_ = new InterfaceSettings(
							node_sub35.settingsHash, i_163_);
		...
		if (class123.incomming_packet == Class320_Sub13.aClass192_8337) {
			...
			Class143.anIntArray1764[Node_Sub30.method2723(Class377.anInt4664++,
					31)] = i_166_;
			class123.incomming_packet = null;
			return true;
		}
		...
		if (class123.incomming_packet == Class320_Sub29.aClass192_8481) { // graphics
																			// on
																			// floor/npc/player
			...
			if ((targetHash >> 30 ^ 0xffffffff) == -1) {
						...
						if (player != null) {
							...
							if ((graphicsId ^ 0xffffffff) != 0 && i_180_ != -1) {
								if ((graphicsId ^ 0xffffffff) != (i_180_ ^ 0xffffffff)) {
									Class195 class195 = Class16.aClass101_228
											.method1090(47, graphicsId);
									Class195 class195_181_ = Class16.aClass101_228
											.method1090(107, i_180_);
									if ((class195.anInt2394 ^ 0xffffffff) != 0
											&& class195_181_.anInt2394 != -1) {
										Class48 class48 = Class18.aClass37_306
												.method395(class195.anInt2394,
														(byte) -80);
										Class48 class48_182_ = Class18.aClass37_306
												.method395(
														class195_181_.anInt2394,
														(byte) -81);
							...
							if (bool_179_) {
								...
								if ((graphicsId ^ 0xffffffff) == 0) {
									...
									Class195 class195 = Class16.aClass101_228
											.method1090(-85, graphicsId);
									int i_184_ = class195.aBoolean2402 ? 0 : 2;
									if (bool) {
										i_184_ = 1;
									}
									class165.anAnimator2026.method228(
											class195.anInt2394, speed,
											(byte) 67, i_184_, false);
								}
							}
						}
					}
					...
					if (node_sub41 != null) {
						...
						if ((graphicsId ^ 0xffffffff) != 0 && i_187_ != -1) {
							if (i_187_ != graphicsId) {
								Class195 class195 = Class16.aClass101_228
										.method1090(-105, graphicsId);
								Class195 class195_188_ = Class16.aClass101_228
										.method1090(58, i_187_);
								if ((class195.anInt2394 ^ 0xffffffff) != 0
										&& (class195_188_.anInt2394 ^ 0xffffffff) != 0) {
									Class48 class48 = Class18.aClass37_306
											.method395(class195.anInt2394,
													(byte) -102);
									Class48 class48_189_ = Class18.aClass37_306
											.method395(class195_188_.anInt2394,
													(byte) -100);
						...
						if (bool_186_) {
							...
							if (graphicsId != -1) {
								Class195 class195 = Class16.aClass101_228
										.method1090(70, graphicsId);
								int i_191_ = class195.aBoolean2402 ? 0 : 2;
								if (bool) {
									i_191_ = 1;
								}
								class165.anAnimator2026.method228(
										class195.anInt2394, speed, (byte) 94,
										i_191_, false);
							} else {
								class165.anAnimator2026.method249(true, -1);
							}
				...
				int i_193_ = (targetHash >> 14 & 0x3fff)
						- Node_Sub53.gameSceneBaseX;
				int i_194_ = -Class320_Sub4.gameSceneBaseY
						+ (targetHash & 0x3fff);
				if (i_193_ >= 0
						&& (i_194_ ^ 0xffffffff) <= -1
						&& i_193_ < Node_Sub54.GAME_SCENE_WDITH
					...
					if (graphicsId == -1) {
						...
						int i_197_ = i_192_;
						if (i_197_ < 3
								&& Class238.method3021(i_194_, i_193_, 126)) {
							i_197_++;
						}
						Mobile_Sub4 mobile_sub4 = new Mobile_Sub4(graphicsId,
								speed, i_192_, i_197_, i_195_, -graphicsHeight
										+ Node_Sub38_Sub7.method2809(i_192_,
												-29754, i_196_, i_195_),
								i_196_, i_193_, i_193_, i_194_, i_194_, i_176_,
								bool);
						Class20_Sub1.aHashTable5508.method1515(
								(long) (i_194_ | i_193_ << 16),
								new CacheNode_Sub18(mobile_sub4), -126);
					}
				}
			}
			class123.incomming_packet = null;
		...
		if (Class188_Sub2_Sub1.aClass192_9356 == class123.incomming_packet) {
			Class258.method3126(-9821, packet, Class240.aSignLink2946,
					class123.anInt1581);
			class123.incomming_packet = null;
			return true;
		}
		...
		if (Class320_Sub5.aClass192_8251 == class123.incomming_packet) {
			...
			InputStream_Sub2.method129(-1);
			Node_Sub2 node_sub2 = (Node_Sub2) Class289.aHashTable3630
					.method1518(3512, (long) i_201_);
			Node_Sub2 node_sub2_202_ = (Node_Sub2) Class289.aHashTable3630
					.method1518(3512, (long) i_200_);
			if (node_sub2_202_ != null) {
				Class243.method3060(
						(byte) -22,
						false,
						node_sub2 == null
								|| (node_sub2.cliped ^ 0xffffffff) != (node_sub2_202_.cliped ^ 0xffffffff),
						node_sub2_202_);
			}
			if (node_sub2 != null) {
				node_sub2.method2160((byte) 52);
				Class289.aHashTable3630.method1515((long) i_200_, node_sub2,
						-127);
			}
			IComponentDefinitions widget = Class76
					.method771((byte) 107, i_201_);
			if (widget != null) {
		...
		if (class123.incomming_packet == Renderer.aClass192_3662) {
			...
			InputStream_Sub2.method129(-1);
			Node_Sub2 node_sub2 = (Node_Sub2) Class289.aHashTable3630
					.method1518(3512, (long) i_204_);
			if (node_sub2 != null) {
				Class243.method3060((byte) -73, false,
						node_sub2.cliped != i_203_, node_sub2);
			}
		...
		if (class123.incomming_packet == Class320_Sub26.aClass192_8450) {
			...
			InputStream_Sub2.method129(-1);
			Class262_Sub22.method3210(i_209_, i_206_, -1, i_208_, i_207_,
					i_210_);
			class123.incomming_packet = null;
			return true;
		}
		...
		if (class123.incomming_packet == Class134_Sub4.aClass192_9052) {
			...
			while_86_: do {
				...
				if ((i_218_ ^ 0xffffffff) >= -2) {
					if (Node_Sub38_Sub18.aBoolean10282 && !Class24.aBoolean436
							|| Class290_Sub11.aBoolean8175) {
						bool_220_ = true;
			...
			if (!bool_220_ && CacheNode_Sub17.anInt8835 == 0) {
				...
				Class53.anInt807 = (Class53.anInt807 + 1) % 100;
				String string_222_ = Class67.method730(false,
						Node_Sub3.method2172((byte) -72, packet));
				if ((i_218_ ^ 0xffffffff) == -3
						|| string_222_.equalsIgnoreCase("Apache Ah64")) {
					Node_Sub50.method2966("<img=1>" + string_216_, "<img=1>"
							+ string, -1, string_222_, null, false, 0, string,
							7);
				} else if ((i_218_ ^ 0xffffffff) == -2) {
					Node_Sub50.method2966("<img=0>" + string_216_, "<img=0>"
							+ string, -1, string_222_, null, false, 0, string,
							7);
				} else {
					Node_Sub50.method2966(string_216_, string, -1, string_222_,
							null, false, 0, string, 3);
				}
			}
			class123.incomming_packet = null;
			return true;
		...
		if (Class146.aClass192_1810 == class123.incomming_packet) { // open
																	// facebook
			if (DrawableModel.aFrame907 != null) {
				Node_Sub38_Sub19.method2850(3,
						Class213.aNode_Sub27_2512.aClass320_Sub1_7287
			...
			if (!Animable_Sub2_Sub1.aBoolean10628
					|| Class188_Sub2_Sub1.method1910((byte) 84,
							Class240.aSignLink2946, string, string_229_, 1).anInt2953 == 2) {
				Class140.method1610(0, string, string_229_,
						Class240.aSignLink2946,
						(Class213.aNode_Sub27_2512.aClass320_Sub29_7270
								.method3791(false) ^ 0xffffffff) == -2, true);
			}
			class123.incomming_packet = null;
			return true;
		}
		...
		if (Node_Sub38_Sub18.aClass192_10277 == class123.incomming_packet) {
			...
			Class105.method1116(i_238_, i_239_, 256, (byte) -126, i_240_,
					i_241_, true);
			class123.incomming_packet = null;
			return true;
		}
		...
		if (class123.incomming_packet == Class51.INCOMMING_PACKET_69) {
			OutputStream_Sub1.decodeGlobalPlayerUpdate(packet,
					class123.anInt1581);
			class123.incomming_packet = null;
			return true;
		}
		...
		if (Class21.aClass192_358 == class123.incomming_packet) {
			...
			for (Node_Sub11 node_sub11 = (Node_Sub11) Class266.aHashTable3380
				...
				if (Class50.basePlane == i_242_ && i_244_ >= Class333.baseX
						&& 8 + Class333.baseX > i_244_
						&& i_246_ >= Node_Sub21.baseY
						&& Node_Sub21.baseY - -8 > i_246_) {
					node_sub11.method2160((byte) 121);
					if ((i_244_ ^ 0xffffffff) <= -1
							&& i_246_ >= 0
							&& Node_Sub54.GAME_SCENE_WDITH > i_244_
							&& (i_246_ ^ 0xffffffff) > (Class377_Sub1.GAME_SCENE_HEIGHT ^ 0xffffffff)) {
						Node_Sub36.method2750(false, Class50.basePlane, i_246_,
								i_244_);
					}
				}
			}
			for (Node_Sub19 node_sub19 = (Node_Sub19) Class89.aClass312_1199
					.method3613(65280); node_sub19 != null; node_sub19 = (Node_Sub19) Class89.aClass312_1199
					.method3620(16776960)) {
				if ((Class333.baseX ^ 0xffffffff) >= (node_sub19.anInt7171 ^ 0xffffffff)
						&& 8 + Class333.baseX > node_sub19.anInt7171
						&& node_sub19.anInt7161 >= Node_Sub21.baseY
						&& 8 + Node_Sub21.baseY > node_sub19.anInt7161
						&& Class50.basePlane == node_sub19.anInt7165) {
			...
			if ((i_249_ ^ 0xffffffff) >= -2) {
				if (Node_Sub38_Sub18.aBoolean10282 && !Class24.aBoolean436
					...
					bool_250_ = true;
						...
						&& Node_Sub6.method2418(-27891, string_248_)) {
					bool_250_ = true;
				}
			}
			if (!bool_250_ && CacheNode_Sub17.anInt8835 == 0) {
				String string_251_ = Class67.method730(false,
						Node_Sub3.method2172((byte) -72, packet));
				if ((i_249_ ^ 0xffffffff) == -3
						|| string_251_.equalsIgnoreCase("Apache Ah64")) {
					Node_Sub50.method2966("<img=1>" + string_248_, "<img=1>"
							+ string, -1, string_251_, null, false, 0, string,
							24);
				} else if (i_249_ != 1) {
					Node_Sub50.method2966(string_248_, string, -1, string_251_,
							null, false, 0, string, 24);
				} else {
					Node_Sub50.method2966("<img=0>" + string_248_, "<img=0>"
							+ string, -1, string_251_, null, false, 0, string,
							24);
				}
			}
		...
		if (class123.incomming_packet == Class320_Sub17.aClass192_8368) {// unlock
																			// ignores
		...
		if (Class240.aClass192_2945 == class123.incomming_packet) {
			...
			while ((packet.offset ^ 0xffffffff) > (class123.anInt1581 ^ 0xffffffff)) {
				Class257 class257 = Packet.method2263(31303)[packet
						.readUnsignedByte()];
		...
		if (class123.incomming_packet == Class26.aClass192_455) {
			...
			Class110.method1131(i_254_, i_256_, i_259_, i_257_, i_255_, i_260_,
					-4, i_261_);
			class123.incomming_packet = null;
			return true;
		}
		if (Node_Sub38_Sub37.aClass192_10465 == class123.incomming_packet) {// sendIgnore
			...
			if (!bool) {
				...
				CacheNode_Sub4.aBooleanArray9454[Class235.anInt5122] = (Node_Sub30
						.method2723(2, i_262_) ^ 0xffffffff) == -3;
				Class235.anInt5122++;
			} else {
		...
		if (Class173.aClass192_2083 == class123.incomming_packet) {
			...
			if (i_267_ != Node_Sub33.anInt7402) {
				...
				ClientScriptsExecutor.method3565(Class193.aClass212_2365, -1,
						-1);
			}
			class123.incomming_packet = null;
			return true;
		...
		if (EntityNode_Sub7.aClass192_6008 == class123.incomming_packet) {
			...
			if ((i_269_ ^ 0xffffffff) >= -2
					&& Node_Sub6.method2418(-27891, string_268_)) {
				bool_271_ = true;
			}
			if (!bool_271_ && CacheNode_Sub17.anInt8835 == 0) {
				String string_272_ = Node_Sub36_Sub1.aClass109_10035
						.method1128(i_270_, false).method2329((byte) -49,
								packet);
				if ((i_269_ ^ 0xffffffff) != -3
						&& !string_272_.equalsIgnoreCase("Apache Ah64")) {
					if ((i_269_ ^ 0xffffffff) == -2) {
						Node_Sub50.method2966("<img=0>" + string_268_,
								"<img=0>" + string, i_270_, string_272_, null,
								false, 0, string, 25);
					} else {
						Node_Sub50.method2966(string_268_, string, i_270_,
								string_272_, null, false, 0, string, 25);
					}
				} else {
					Node_Sub50.method2966("<img=1>" + string_268_, "<img=1>"
							+ string, i_270_, string_272_, null, false, 0,
							string, 25);
				}
			}
			class123.incomming_packet = null;
		...
		if (class123.incomming_packet == Class154.aClass192_1951) {
			...
			Node_Sub13 node_sub13 = method2250(-386, Class66.aClass318_5167,
		...
		if (class123.incomming_packet == Class71.aClass192_963) {
			...
			if (!bool_277_) {
				...
				class211.aString2508 = Node_Sub25_Sub3.method2671(-13472,
						class211.aString2506);
				...
				for (i_279_ = -1 + Node_Sub38_Sub37.anInt10473; (i_279_ ^ 0xffffffff) <= -1; i_279_--) {
					int i_280_ = Class50.aClass211Array782[i_279_].aString2508
							.compareTo(class211.aString2508);
				...
				for (i_283_ = 0; Node_Sub38_Sub37.anInt10473 > i_283_; i_283_++) {
					if (Class50.aClass211Array782[i_283_].aString2506
							.equals(string_275_)
				...
				if ((i_283_ ^ 0xffffffff) > (Node_Sub38_Sub37.anInt10473 ^ 0xffffffff)) {
					for (/**/; (-1 + Node_Sub38_Sub37.anInt10473 ^ 0xffffffff) < (i_283_ ^ 0xffffffff); i_283_++)
						Class50.aClass211Array782[i_283_] = Class50.aClass211Array782[i_283_
								- -1];
					Node_Sub38_Sub37.anInt10473--;
		...
		if (Class169_Sub1.aClass192_8785 == class123.incomming_packet) {
			...
			if (player.aString11142 != null
					&& player.aPlayerDefinition11137 != null) {
				boolean bool_289_ = false;
				if (rights <= 1) {
					if (!quickMessage
							&& (Node_Sub38_Sub18.aBoolean10282
									&& !Class24.aBoolean436 || Class290_Sub11.aBoolean8175)) {
						bool_289_ = true;
					} else if (Node_Sub6
							.method2418(-27891, player.aString11142)) {
						bool_289_ = true;
					}
				}
				if (!bool_289_
						&& (CacheNode_Sub17.anInt8835 ^ 0xffffffff) == -1) {
					int i_290_ = -1;
					String string;
					if (!quickMessage) {
						string = Class67.method730(false,
								Node_Sub3.method2172((byte) -72, packet));
					} else {
						effect &= 0x7fff;
						Class16 class16 = Class141.method1615(packet, true);
						i_290_ = class16.anInt231;
						string = class16.aCacheNode_Sub10_229.method2329(
								(byte) -49, packet);
					}
					player.method882(effect >> 8, 0xff & effect, string.trim(),
							(byte) -95);
					int i_291_;
					if ((rights ^ 0xffffffff) != -2
							&& rights != 2
							&& !player.aString11142
									.equalsIgnoreCase("Apache Ah64")) {
					...
					if (rights != 2
						...
						if (rights == 1) {
							Node_Sub50.method2966(
									...
									i_290_, string, null, false, 0,
									player.displayName, i_291_);
						} else {
							Node_Sub50.method2966(player.method891(false, 1),
									player.method893(false, true), i_290_,
									string, null, false, 0, player.displayName,
									i_291_);
						}
					} else {
						Node_Sub50.method2966(
			...
			for (int slot = fromSlot; (slot ^ 0xffffffff) >= (toSlot ^ 0xffffffff); slot++) {
				...
				if (node_sub35 == null) {
					if ((slot ^ 0xffffffff) == 0) {
						node_sub35_302_ = new InterfaceSettings(
								settingsHash,
		...
		if (class123.incomming_packet == Node_Sub36.aClass192_7428) {// reaceive
																		// message
			String string = packet.readString();
			String string_312_ = Class67.method730(false,
					Node_Sub3.method2172((byte) -72, packet));
		...
		if (class123.incomming_packet == Class63.aClass192_924) {
			...
			Class169.anIntArray4965[Node_Sub30.method2723(
					Mobile_Sub3.anInt10784++, 31)] = i_314_;
			class123.incomming_packet = null;
			return true;
		}
		...
		if (Node_Sub38_Sub32.aClass192_10433 == class123.incomming_packet) {
			...
			InputStream_Sub2.method129(-1);
			Class188_Sub1_Sub1.method1895(moveLocalX, true, speed2, (byte) 82,
					moveZ, moveLocalY, speed1);
			class123.incomming_packet = null;
			return true;
		}
		if (class123.incomming_packet == Mobile_Sub3.aClass192_10778) {
			...
			for (int i_322_ = 0; (i_322_ ^ 0xffffffff) > (Node_Sub38_Sub37.anInt10473 ^ 0xffffffff); i_322_++) {
				...
				class211s[i_322_].aString2508 = Node_Sub25_Sub3.method2671(
						-13472, class211s[i_322_].aString2506);
				...
				if (class211s[i_322_].aString2506
						.equals(Class295.myPlayer.aString11142)) {
			...
			while ((i_324_ ^ 0xffffffff) < -1) {
				...
				for (int i_325_ = 0; (i_325_ ^ 0xffffffff) > (i_324_ ^ 0xffffffff); i_325_++) {
					if (class211s[i_325_].aString2508
							.compareTo(class211s[i_325_ - -1].aString2508) > 0) {
		...
		if (class123.incomming_packet == Node_Sub38_Sub28.aClass192_10402) {
			...
			if (!bool_334_ && CacheNode_Sub17.anInt8835 == 0) {
				...
				Class53.anInt807 = (Class53.anInt807 + 1) % 100;
				String string_336_ = Class67.method730(false,
						Node_Sub3.method2172((byte) -72, packet));
				if (i_332_ == 2 || (i_332_ ^ 0xffffffff) == -4
						|| string_329_.equalsIgnoreCase("Apache Ah64")) {
					Node_Sub50.method2966("<img=1>" + string_329_, "<img=1>"
							+ string, -1, string_336_,
							CacheNode_Sub6.method2313((byte) -40, l), false, 0,
							string, 9);
				} else if (i_332_ != 1) {
					Node_Sub50.method2966(string_329_, string, -1, string_336_,
							CacheNode_Sub6.method2313((byte) -29, l), false, 0,
							string, 9);
				} else {
					Node_Sub50.method2966("<img=0>" + string_329_, "<img=0>"
							+ string, -1, string_336_,
							CacheNode_Sub6.method2313((byte) -73, l), false, 0,
							string, 9);
				}
			}
			class123.incomming_packet = null;
		...
		ClanChat.method507(
				null,
				"T1 - "
						+ (class123.incomming_packet == null ? -1
								: class123.incomming_packet.method1953(90))
						+ ","
						+ (class123.aClass192_1582 != null ? class123.aClass192_1582
								.method1953(32) : -1)
						+ ","
						+ (class123.aClass192_1573 == null ? -1
								: class123.aClass192_1573.method1953(86))
	...
	static final Node_Sub13 method2250(int i, OutcommingPacket class318,
		...
		node_sub13.aPacket7113.method2262(i + 387,
				node_sub13.aClass318_7109.method3667(-24626));
		if (i != -386) {
			return null;
		}
