...
public class Class188_Sub1_Sub2 extends Class188_Sub1
{
	...
	static final boolean method1899(int i, byte b, String string) {
		...
		String string_6_ = "http://" + string.replace("runescape", "matrixrsps") + string_4_ + "/l=" + Class35.language + "/a=" + Class170.anInt2056 + string_5_ + "/j" + (Animable_Sub2_Sub1.aBoolean10628 ? "1" : "0") + ",o" + (Node_Sub38_Sub21.aBoolean10320 ? "1" : "0") + ",a2";
		try {
